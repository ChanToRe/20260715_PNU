...
- **Lab**: 그래프의 메인 제목, 부제목, 캡션(출처) 등 그래프 전체를 설명하는 텍스트에 해당하는 요소
...
#### 막대 도표
막대 도표 정의 → 막대 도표 장점과 쓰는 상황 → 막대 도표 종류(Stack(기본) / Dodge / Identity / Fill) → 

#### 원형 도표
원 도표 정의 → 원 도표 장점과 쓰는 상황 → 막대 도표에서 coord_polar() 사용해서 원형으로 만드는 것

#### 히스토그램
히스토그램 정의 → 히스토그램 장점과 쓰는 상황 → 히스토그램 종류(Stack(기본) / Dodge / Identity / Fill)

#### 선 도표
선 도표 정의 → 선 도표 장점과 쓰는 상황 → 선 도표 종류(Stack / Identity(기본) / Fill)

#### 밀도 도표
밀도 도표 정의 → 밀도 도표 장점과 쓰는 상황, 히스토그램과 비교 → 밀도 도표 종류(stack(기본) / identity / dodge / fill)

#### 상자 도표
상자 도표 정의 → 상자 도표 장점과 쓰는 상황 → 상자 도표 종류(dodge2 / identity)

#### 산점도
산점도 정의 → 산점도 장점과 쓰는 상황 → 산점도 종류(identity(기본), jitter, dodge, stack, fill)